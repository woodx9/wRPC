...
static void InitDefaultsscc_info_RpcHeader_rpcheader_2eproto() {
  ...
  {
    void* ptr = &::wrpc::_RpcHeader_default_instance_;
    new (ptr) ::wrpc::RpcHeader();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::wrpc::RpcHeader::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::wrpc::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::wrpc::RpcHeader, service_name_),
  PROTOBUF_FIELD_OFFSET(::wrpc::RpcHeader, method_name_),
  PROTOBUF_FIELD_OFFSET(::wrpc::RpcHeader, args_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::wrpc::RpcHeader)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::wrpc::_RpcHeader_default_instance_),
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\004wrpc\"I\n\tRpcHeader\022\024\n\014"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpcheader_2eproto = {
  false, false, descriptor_table_protodef_rpcheader_2eproto, "rpcheader.proto", 106,
...
// @@protoc_insertion_point(generalized_merge_from_start:wrpc.RpcHeader)
  GOOGLE_DCHECK_NE(&from, this);
  const RpcHeader* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RpcHeader>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:wrpc.RpcHeader)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:wrpc.RpcHeader)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:wrpc.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::wrpc::RpcHeader* Arena::CreateMaybeMessage< ::wrpc::RpcHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::wrpc::RpcHeader >(arena);
}
